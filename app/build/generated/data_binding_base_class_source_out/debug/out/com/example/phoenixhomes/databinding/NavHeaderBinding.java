...
public final class NavHeaderBinding implements ViewBinding {
  ...
  private NavHeaderBinding(@NonNull ConstraintLayout rootView, @NonNull TextView Banner,
      @NonNull ConstraintLayout cardView, @NonNull TextView textView2) {
  ...
  public static NavHeaderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NavHeaderBinding((ConstraintLayout) rootView, Banner, cardView, textView2);
    }
